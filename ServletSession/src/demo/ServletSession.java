 ...
 */
@WebServlet(description = "SessionDemo", urlPatterns = { "/ServletSession" })
public class ServletSession extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// sets the time, in seconds, between client requests before the servlet container invalidates this session
